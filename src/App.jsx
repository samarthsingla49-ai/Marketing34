  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      if (window.scrollY > 60) {
        ...
        el.style.padding        = '1rem 6vw'
      } else {
        el.style.background     = 'transparent'
        el.style.backdropFilter = 'none'
        el.style.padding        = '1.75rem 6vw'
      }
    }
    ...
    >
      ...
      >
        ...
        <span style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
          <span style={{ width: '22px', height: '1.5px', background: 'var(--black)', display: 'block' }} />
          <span style={{ width: '15px', height: '1.5px', background: 'var(--black)', display: 'block' }} />
        </span>
      </button>
    </header>
  )
...
function Philosophy () {
  return (
    ...
    >
      ...
      <div
        data-reveal
        style={{ width: '3.5rem', height: '3px', background: 'var(--blue)', marginTop: '4rem' }}
      />
    ...
    >
      ...
      <div data-reveal style={{ paddingBottom: '6rem' }}>
        ...
        >
          ...
          <span
            ...
            style={{
              color     : '#4ade80',
              borderBottom: '0.07em solid #4ade80',
              cursor    : 'none',
      ...
      >
        {[
          ...
          <div key={h}>
            <p style={{ color: '#555', marginBottom: '1rem' }}>{h}</p>
            {items.map(item => (
              <p key={item} style={{ fontSize: '0.75rem', marginBottom: '0.5rem' }}>{item}</p>
            ))}
          </div>
        ))}
      </div>
